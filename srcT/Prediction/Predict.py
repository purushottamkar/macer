...
from srcT.Prediction.Globals import edit_tkn,tkn,idx_to_bigram,new_encoder,flat_rankers,repl_or_not,ins_del_model,repl_class_model,repl_encoder,ins_class_model,ins_encoder,del_class_model,del_encoder,rest_class_model,rest_encoder,repl_clusters,ins_clusters,del_clusters,rest_clusters
from srcT.Prediction import Globals
...
def predictAbs(srcAbsLine,errSet,trgtAbsLine, predAtK):    
...
def test(src_line,errs,predAtK):
